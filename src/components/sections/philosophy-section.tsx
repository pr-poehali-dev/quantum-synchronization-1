...
export function PhilosophySection() {
  return (
    <section id="philosophy" className="relative w-full py-16 md:py-24 overflow-hidden">
      <AnimatedBackground variant="gradient" color="rgba(220, 38, 38, 0.05)" secondaryColor="rgba(30, 58, 100, 0.08)" />
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-start">
            ...
            <div className="flex flex-col gap-6">
              <div className="rounded-2xl border border-border bg-card p-6 md:p-8 flex flex-col gap-5">
                <p className="text-foreground leading-relaxed">
                  ...
                  <span className="text-red-500 font-semibold">новая силовая установка</span>, собранная из новых компонентов и качественно восстановленных оригинальных деталей по инженерному регламенту.
                </p>
                ...
                <div className="flex flex-col gap-3 pt-2 border-t border-border">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-red-600/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Icon name="Target" className="h-4 w-4 text-red-600" />
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-red-600/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Icon name="FileCheck" className="h-4 w-4 text-red-600" />
                    </div>
                    <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <ScrollReveal delay={0.2}>
            <div className="rounded-2xl border border-red-600/20 bg-card p-6 md:p-8 shadow-[0_0_30px_rgba(220,38,38,0.08)]">
              <h3 className="text-lg font-heading font-bold mb-6 flex items-center gap-2">
                <Icon name="ListChecks" className="h-5 w-5 text-red-600" />
                Ключевые принципы
              </h3>
              <div className="flex flex-col gap-4">
                {principles.map((principle, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-600/15 border border-red-600/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Icon name="Check" className="h-3 w-3 text-red-500" />
                    </div>
